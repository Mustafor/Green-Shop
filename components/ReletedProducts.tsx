...
const ReletedProducts = () => {
  return (
    <div className="px-[120px]">
      <div>
        <h2 className="text-[17px] text-[#46A358] mb-[12px] font-bold">
          Releted Products
        </h2>
        ...
        <ul className="mt-[44px] flex items-center gap-[26px]">
          <li className="w-[219px] hover:shadow-2xl duration-300">
            ...
            <strong className="mt-[12px] text-[15px] flex text-[#3D3D3D]">
              Beach Spider Lily
            </strong>
            <strong className="text-[16px] font-bold text-[#46A358] mt-[5px]">
              $129.00
            </strong>
          </li>
          <li className="w-[219px] hover:shadow-2xl duration-300">
        ...
        <Link className="flex items-center justify-center mt-[61px]" href="#">
          <Carusel />
        </Link>
      </div>
    </div>
