...
const Modal: React.FC<ModalType> = ({ isOpen, setIsOpen, width, children }) => {
  ...
  return (
    <div onClick={handleClickOutside} id="wrapper" className={`fixed z-50 inset-0 duration-300 backdrop-blur bg-[#00000029] flex items-center justify-center ${!isOpen && "scale-0"}`}>
